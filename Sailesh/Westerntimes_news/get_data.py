...
def save_csv(dataframe, file):
    ...
    #dataframe.to_csv("./westerntimes_news_text.csv", index=False)
...
def curate_url():
    ...
    try:
        df = open_csv('./westerntimes_news_url.csv')
    ...
    for base_url in base_urls:
        ...
        while(True):
            ...
            if n_pages%100 == 0:
                ...
                save_csv(df, "./westerntimes_news_url.csv")
...
def curate_text():
    ...
    url_dict = get_url_json("./westerntimesnews_url.json")
    try:
        text_df = pd.read_csv("westertimes_text.csv")
    except Exception as e:
        text_df = pd.DataFrame(columns=["Links", "Text"])
    ...
    for url in url_dict.keys():
        ...
        if count%100 == 0:
            ...
            save_csv(text_df, "./westerntimes_news_text.csv")
        count+=1
        url_dict[url] = 1
